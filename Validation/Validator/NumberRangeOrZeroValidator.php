 ...
 * @scope prototype
 */
class Tx_BallroomDancing_Validation_Validator_NumberRangeOrZeroValidator extends Tx_Extbase_Validation_Validator_AbstractValidator {
	...
	public function isValid($value) {
		$this->errors = array();
		if (!is_numeric($value)) {
			$this->addError('The given subject was not a valid number.', 1275596525);
			return FALSE;
		}
		...
		$this->addError('The given subject was not in the valid range (' . $startRange . ' - ' . $endRange . ').', 1275596526);
		return FALSE;
	}
}
